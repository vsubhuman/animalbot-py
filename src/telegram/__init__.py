...
class Bot:
    ...
    def send_photo(self, chat_id, photo, text=None):
        self.send('sendPhoto', {'chat_id': chat_id, 'photo': photo, 'caption': text})

    def send_video(self, chat_id, video, text=None):
        self.send('sendPhoto', {'chat_id': chat_id, 'video': video, 'caption': text})

    def leave_chat(self, chat_id):
        self.send('leaveChat', {'chat_id': chat_id})
